--------------------------------------------------------
--  DDL for Procedure PROC_TMTRAN_ACCT_SYNC
--------------------------------------------------------
set define off;

  CREATE OR REPLACE EDITIONABLE PROCEDURE "PROC_TMTRAN_ACCT_SYNC" (p_acct_no VARCHAR2) is
  v_count      NUMBER;
  p_date       date;
  v_start_date DATE;
    ...
    BEGIN
      ...
      INSERT INTO sync_ddhist
        ...
        --'DD' || SEQ_CORE_SN_DD.NEXTVAL
          FROM svhispv51.ddhist@dblink_data1 a
