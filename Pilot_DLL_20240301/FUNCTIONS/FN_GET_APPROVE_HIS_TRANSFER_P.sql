--------------------------------------------------------
--  DDL for Function FN_GET_APPROVE_HIS_TRANSFER_P
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE FUNCTION "IBS"."FN_GET_APPROVE_HIS_TRANSFER_P" (P_WF_PROCESS_ID VARCHAR2)
RETURN VARCHAR2 AS
...
BEGIN
  ...
  RETURN NULL;
END FN_GET_APPROVE_HIS_TRANSFER_P;
