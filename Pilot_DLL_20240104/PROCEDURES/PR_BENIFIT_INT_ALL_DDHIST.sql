--------------------------------------------------------
--  DDL for Procedure PR_BENIFIT_INT_ALL_DDHIST
--------------------------------------------------------
set define off;

  CREATE OR REPLACE EDITIONABLE PROCEDURE "IBS"."PR_BENIFIT_INT_ALL_DDHIST" (p_date7 NUMBER)
 as
    ...
    CURSOR c_txn (p_cur_date7 NUMBER, p_cur_date_dt DATE)
        IS
                ...
                FROM ibs.bk_account_history h, HSTAGING.SI_HIS_DDHIST@HSTAGING_PRO_CORE his, ibs.cstb_account_info bka
                WHERE 1=1
                ...
                AND h.amount = his.amt --#20170207 Loctx add for fix loi hay bi thong tin thu huong lien ngan hang la Maritimebank
