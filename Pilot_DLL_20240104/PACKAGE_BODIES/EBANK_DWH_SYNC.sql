...
--------------------------------------------------------
 ...
 IS
  ...
  BEGIN
    MERGE INTO   bk_account_history c
                        USING   (
                        SELECT distinct a.trn_date,a.channel_trn,a.seq_number,a.user_id,a.trf_bank_sk,a.related_person,LPAD(b.account_no, 14, '0') account_no,
                        a.related_account
 ...
 THEN
  ...
  BEGIN
    MERGE INTO   bk_account_history c
                        USING   (
                        SELECT distinct a.trn_date,a.channel_trn,a.trn_seq,a.maker_id,a.trf_bank,a.related_person,LPAD(a.account_no, 14, '0') account_no,
                        a.related_account
