        ...
        LOOP
            ...
            INSERT INTO sync_lnhist
              ...
              FROM   --STAGING.SI_HIS_LNHIST@STAGING_PRO_CORE a,
                    HSTAGING.SI_HIS_LNHIST@HSTAGING_PRO_CORE a, --20160426 QuanPD changed STAGING->CORE
                    sync_account_info x
      ...
      BEGIN
        ...
        INSERT INTO sync_ddhist
          ...
          FROM   --STAGING.si_his_ddhist@STAGING_PRO_core a,
                HSTAGING.SI_HIS_DDHIST@HSTAGING_PRO_CORE a, --20160426 QuanPD changed STAGING->CORE 
