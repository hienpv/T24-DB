--------------------------------------------------------
--  DDL for Package Body CSPKG_ACCOUNT_SYNC_DEV_THANH
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "IBS"."CSPKG_ACCOUNT_SYNC_DEV_THANH" 
...
*/
                ...
                USING(SELECT
                        ...
                        FROM dual
                        WHERE SUBSTR(l_acct_no, 4, 2) <> '31' AND SUBSTR(l_acct_no, 4, 2) <> '13'
                        ) src
