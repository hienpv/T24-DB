...
--------------------------------------------------------
  ...
  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "IBS"."GW_PK_LIB" is
  ...
  **********************************************************************/
  ...
  /***********************************************************/
  -- Ham lay noi dung cua 1 field cua dien IBPS trong toan bo noi dung dien
  -- Nguoi tao          :QuanLD
  -- Ten ham            :GET_IBPS_Field()
  -- Tham so            pCOntent varchar2, -- noi dung toan bo message
  --                    FiledCode varchar2, --Ten field
  --
  -- Gis tri tra ve: noi dung cua field do trong dien
  -- Ngay tao:23/05/2008
  /*********************************************************/
